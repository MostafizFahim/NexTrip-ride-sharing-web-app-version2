...
import UserActiveRidePage from "../Pages/userInterface-pages/UserActiveRidePage.js";
...
import UserPlaceholderPage from "../Pages/userInterface-pages/UserPlaceholderPage.js";
    ...
    <>
      <Router>
        ...
        <Switch>
          ...
          <Route path="/driver-dashboard" exact component={UserDashboardPage} />
          ...
          />
          <Route
            path="/user-dashboard/activeride"
            component={UserActiveRidePage}
          />
          ...
          <Route
            ...
            render={() => (
              <UserPlaceholderPage
                title="Payments"
                message="Payment UI is ready for future backend integration."
              />
            )}
          />
          <Route
            ...
            render={() => (
              <UserPlaceholderPage
                title="Support"
                message="Support tickets can be connected when the backend is added."
              />
            )}
          />
